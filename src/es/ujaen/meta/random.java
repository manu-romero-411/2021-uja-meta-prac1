...
public class random {
   ...
   (incluyendo el 0 pero sin incluir el 1) */
    public float Rand(){
        //return (( Seed = ( MASK & (PRIME * Seed)) ) * SCALE ); // hay aquí una operación AND y habría que usar un tipo de datos distinto que permita trabajar con los números bit a bit
    }
